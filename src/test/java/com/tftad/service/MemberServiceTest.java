...
//
//        // when
//        MemberResponseDetail memberResponseDetail = memberService.get(memberId);
//
//        // then
//        assertEquals("email", memberResponseDetail.getEmail());
//        assertEquals("name", memberResponseDetail.getName());
//    }
//
//    @Test
